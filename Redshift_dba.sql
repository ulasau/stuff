...
-- current compression encoding for a table
select "column", type, encoding
from pg_table_def
where tablename = 'table_name'

-- inspect tables size ( assuming each block is 1 MB)
...
-- tables ddl's (https://github.com/awslabs/amazon-redshift-utils/blob/master/src/AdminViews/v_generate_tbl_ddl.sql)
SELECT
